...
<form method="post" action="php/result.php" id="searchbar">
...
<form method="post" action="php/sell.php" id="sell">
     <table>
			<tr>
				<td>Enter Title</td>
				<td></td><td>Price</td>
			...
			<tr>
				...
				<td style="margin-right:50px; margin-left:none;">$</td><td><input type="text" name="price" placeholder="00.00" size="2"></td>
				<td><button type="submit" formtarget="sell"> Post Sale </button></td>
			</tr>
